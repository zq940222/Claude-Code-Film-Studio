---
name: new-drama
description: 新建影视项目（短剧/电影短片/动漫番剧/创意段子）。收集片名、创作形态、题材、画幅（9:16/16:9）、每集时长、集数，创建标准项目目录和 project.json。用户说"新建短剧"、"新建项目"、"做部动漫"、"拍个短片"、"做搞笑段子"、"/new-drama"时使用。
---
...
1. 用 AskUserQuestion 收集（用户在参数里已给的不重复问）：
   - **片名**（可暂定）
   - **创作形态**：短剧（竖屏快节奏，抖音/快手）/ 电影短片（横屏电影感叙事）/ 动漫番剧（二次元画风，B站/抖音）/ 创意段子（无厘头搞笑独立短条，抖音+B站双主打）
   - **题材**：都市逆袭 / 甜宠 / 悬疑 / 玄幻 / 科幻 / 热血 / 其他（创意段子的"题材"= 人设方向，如 职场吐槽 / 家庭日常 / 反转脑洞）
   - **画幅**：9:16 竖屏 或 16:9 横屏（短剧/创意段子默认竖屏，电影短片默认横屏，动漫两者皆可）
   - **每集时长**：短剧 60-120 秒；电影短片 180-600 秒；动漫番剧 120-300 秒；创意段子 30-90 秒
   - **集数**：建议先做 1 集试水验证流程，再批量（创意段子的"集"= 条：每条剧情独立，角色人设全项目共用——一个项目就是一个账号人设宇宙）
...
| 创意段子 | `sketch` | 黄金1秒抓梗、梗密度、结尾反转/玩梗CTA、商单神转折植入 | 真人日常感或卡通夸张，竖屏为主 |

创意段子形态另有**商单机制**（与形态解耦，见 ADR-0002）：接到品牌推广时把 brief 落
`01-script/ep{NN}-sponsor.md`（产品/卖点/口播词/禁忌），编剧按它做神转折植入；建项时**不**收集商单——商单是逐条挂的，进 /script 阶段再说。
